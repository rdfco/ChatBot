...
const CohortData = {
  "ab-test-1-landing": {
    ...
    description:
      "STIM Bot AI-driven open source and privacy-first platform for data exploration. Your data is accessed using your device and stored on your device. No clouds, only sunshine.",
    feature_group_1: {
    ...
    feature_group_2: {
      ...
      description:
        "Your time is too valuable to be looking up column names.<br>Focus on the questions. STIM will handle the rest, instantly.",
    },
    comparison: {
