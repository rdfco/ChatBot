...
export const InstallSection = () => {
  ...
  const installationSections: Item[] = [
    ...
    },
    {
      ...
      code: "brew tap ramiawar/STIM && brew install STIM",
    },
    {
      title: "Docker",
      isDownloadable: false,
      code: "docker run -p 2222:2222 -p 7377:7377 -v STIM:/home/.STIM --name STIM ramiawar/STIM:latest",
    },
    {
      title: "GH Releases",
      code: "https://github.com/RamiAwar/STIM/releases",
      isDownloadable: false,
    },
  ];
