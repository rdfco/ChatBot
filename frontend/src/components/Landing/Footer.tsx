const navigation = {
  ...
  support: [
    ...
    { name: "Email", href: "mailto:support@STIM.app" },
    { name: "GitHub", href: "https://github.com/RamiAwar/STIM" },
    // { name: "Guides", href: "#" },
...
import logomd from "../../assets/images/logo_md.svg";
...
const socials = [
  ...
  {
    name: "GitHub",
    href: "https://github.com/RamiAwar/STIM",
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-4 sm:pt-24 lg:px-8 lg:pt-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <img className="h-14 rounded-md" src={logomd} alt="STIM" />
            ...
            <div className="py-4">
              <a
                href="https://theresanaiforthat.com/ai/STIM/?ref=featured&v=1901847"
                target="_blank"
                rel="nofollow"
              >
                <img
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="mt-8 text-sm leading-5 text-gray-400 md:order-1 md:mt-0">
            &copy; 2024 STIM B.V. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
